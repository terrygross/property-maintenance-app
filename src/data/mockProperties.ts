...
export const mockProperties: Property[] = [
  ...
  {
    id: "6",
    name: "Kensington Flats",
    address: "42 Abbey Road",
    city: "London",
    ...
    units: 32,
    status: "active",
    imageUrl: "https://images.unsplash.com/photo-1529307474719-3d0a417aaf8a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    contactEmail: "enquiries@kensingtonflats.co.uk",
